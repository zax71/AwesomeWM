...
local theme_name = "zaxTheme"
local themes_path = gfs.get_themes_dir() .. "/" .. theme_name .. "/"
...
theme.wallpaper = function(s)
	if s.index % 2 == 0 then
		return themes_path .. "wallpapers/sunsetV2_R.png"
	else
		return themes_path .. "wallpapers/sunsetV2_L.png"
	end
end
